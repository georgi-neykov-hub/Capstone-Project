...
public class PlayerImpl implements Player, AudioManager.OnAudioFocusChangeListener,
        OnCompletionListener, OnErrorListener, OnPreparedListener, OnSeekCompleteListener, MediaPlayer.OnVideoSizeChangedListener {
...
// allowed to reduce the volume instead of stopping playback.
    ...
    private @PlaybackStateCompat.State int mState;
    private boolean mPlayOnFocusGain;
    private Callback mCallback;
    private volatile boolean mAudioNoisyReceiverRegistered;
    private volatile int mCurrentPosition;
    private volatile Episode mCurrentEpisode;
        ...
        public void onReceive(Context context, Intent intent) {
            if (AudioManager.ACTION_AUDIO_BECOMING_NOISY.equals(intent.getAction())) {
                ...
                if (isPlaying()) {
                    ...
                    i.setAction(PlaybackService.ACTION_CMD);
                    i.putExtra(PlaybackService.CMD_NAME, PlaybackService.CMD_PAUSE);
    ...
    public PlayerImpl(PlaybackService service) {
    ...
    @Override
    public void play(Episode target) {
