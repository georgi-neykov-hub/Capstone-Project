...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private final ComponentName mPlayerActivityComponent;
    ...
    public MediaNotificationManager(PlaybackService service, ComponentName playerActivity) {
        mService = service;
    ...
    private PendingIntent createContentIntent(MediaDescriptionCompat description) {
        ...
        openUI.setComponent(mPlayerActivityComponent);
        openUI.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
        openUI.putExtra(PlaybackService.EXTRA_START_FULLSCREEN, true);
        if (description != null) {
            openUI.putExtra(PlaybackService.EXTRA_CURRENT_MEDIA_DESCRIPTION, description);
        }
